...
transformed parameters {
  ...
  for (i in 1:N) {
    ...
    // ELISA uses continuous 
    logit_sens[i, 3] = intercept_sens[2] + onset_coef_sens[2] * days_since_onset[i,1];
...
model {
 ...
 onset_coef_sens[1] ~ normal(0,0.05); //PCR
 onset_coef_sens[2] ~ normal(0,0.01); //ELISA
