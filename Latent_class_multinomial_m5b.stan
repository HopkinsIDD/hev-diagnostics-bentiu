...
parameters {
  ...
  array[1] real intercept_sens; //Intercept for sensitivity regression ONLY FOR PCR
  vector <upper=0> [3] spline_coef_sens;       // Coefficients for spline terms on sensitivity ONLY FOR PCR
...
transformed parameters {
  ...
  for (i in 1:N) {
    ...
    // RDT does not adjust for days since jaundice onset
